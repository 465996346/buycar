...
@Controller
@RequestMapping(Constants.APP_WEB_URL_USER_PREFIX)
public class UserController extends BaseController {
    private static final String WEB_LOGIN_JSP = "login";
    private static final String WEB_LIST_JSP = "user/list";
    private static final String WEB_EDIT_JSP = "user/edit";
    private static final String WEB_ADD_PAGE = "user/add";
    private static final String WEB_LIST_PAGE = "web/user/list";
    ...
    public ModelAndView viewLoginPage() {
        ...
        modelAndView.setViewName(WEB_LOGIN_JSP);
        return modelAndView;
    }
    ...
    public ModelAndView login(@RequestParam(value = "userName", defaultValue = "") String userName, @RequestParam(value = "password", defaultValue = "") String password) {

        ModelAndView modelAndView = new ModelAndView();
        User user = null;
        try {
            user = userService.getByUserName(userName, password);
            user.setPassword(StringUtil.EMPTY);
            this.addSession(Constants.USER, user);
            modelAndView.setView(new RedirectView(AppContext.getContextPath() + "/" + WEB_LIST_PAGE));
        } catch (ParameterException exception) {

        } catch (ServiceException exception) {
            modelAndView.addObject(Constants.TIP_MESSAGE, exception.getMessage());
            modelAndView.setViewName(WEB_LOGIN_JSP);
        }
